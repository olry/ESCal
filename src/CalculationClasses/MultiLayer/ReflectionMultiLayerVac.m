classdef ReflectionMultiLayerVac<BaseMultiLayer
    properties
        theta                  = 0;
        phi                    = [];
        Fm;
    ...
    methods
        function obj = ReflectionMultiLayerVac (Layers, CalculationMethod)
        ...
        function Calculate(obj)
            ...
            for i_layer = (obj.N_Layer-1):-1:1
                if i_layer == 1
                    Rlocal = zeros(size(obj.FullEnergyDistribution{1}.T));
